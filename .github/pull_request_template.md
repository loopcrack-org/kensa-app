<!--
  Shown to anyone opening a pull request here. GitHub does not let a public
  repository turn forking off, so this is the only place to say it before
  someone spends their evening on a change that has nowhere to land.
-->
